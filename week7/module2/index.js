...
function sayHello(player) {
  console.log(
    "Hello " + player.name + "!" + " Your points: " + getScore(player)
  );
}
...
function displayWinner(team1, team2, team3) {
  ...
  if (
    team1.totalTeamScore > team2.totalTeamScore &&
    team1.totalTeamScore > team3.totalTeamScore
  ) {
    // modify this
    //    winner = 'TEAM 1';
    winner = team1;
  } else if (
    team2.totalTeamScore > team1.totalTeamScore &&
    team2.totalTeamScore > team3.totalTeamScore
  ) {
    // winner = 'TEAM 2';
    winner = team2;
  } else {
  ...
  console.log(
    "_____________ *** " + winner.name + " wins! *** _________________"
  );
}
